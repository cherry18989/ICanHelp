...
public class AttentionActivity extends Activity implements AdapterView.OnItemClickListener{
    ...
    private String url = "http://114.55.101.163:8007/FinaRobot/admin.php/Index/getAttentions?";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        attentionPrograssBar = (ProgressBar) findViewById(R.id.attentionProgressBar);
        attentionsView = (LinearLayout) findViewById(R.id.attentionsView);
    ...
    private void showReload(){
        attentionPrograssBar.setVisibility(View.GONE);
        reloadView.setVisibility(View.VISIBLE);
    }
    //显示关注列表界面
    private void showAttentionList(){
        attentionPrograssBar.setVisibility(View.GONE);
        attentionsView.setVisibility(View.VISIBLE);
    }
        ...
        protected void onPostExecute(List<UserInfo> userList) {
            ...
            if(userList==null){
               ...
               //没有关注的人
                ...
                adapter = new RelationshipAdapter(AttentionActivity.this,entityList);
